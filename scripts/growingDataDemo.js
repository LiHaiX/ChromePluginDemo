...
!function t(e, r, n) {
    ...
    1: [function (t, e, r) {
        ...
        var C = new w, O = window.msSetImmediate;
        if (!O) {
            var N = [], S = String(Math.random());
        ...
        c = t("./utils"), s = c.detectIE() || 0 / 0, 9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"), a = t("tree-mirror")), u = t("./info"), c = t("./utils"), i = t("./messaging_observer"), o = t("./server_imp_setting"), d = c.detectIOS() || 0 / 0, n = function () {
            ...
            var e, r, n, s, f, p, g, v, m, w, b, y, C, O, N, S, x, E;
            return s = null, N = 3, p = [], r = {}, f = {}, E = {
                ...
                title: 1,
                use: 1
            }, v = {}, x = null, g = null, S = null, n = !0, e = ["TEXTAREA", "HTML", "BODY"], C = ["button", "submit"], O = ["A", "BUTTON", "INPUT", "IMG"], w = ["I", "SPAN", "EM", "svg"], y = ["A", "BUTTON"], b = y, m = ["radio", "checkbox"], t.prototype.setPageGroup = function (t) {
                ...
                if (o = [], d = !0, t.leaf)1 === t.nodeType && ((null != (h = t.attributes) ? h.href : void 0) || null != t.text || null != t.obj) && (s = this.nodeMessage(t, !0), e > 1 && (s.idx = t.idx), o.push(s)); else if (0 === t.childNodes.length && -1 === c.indexOf(O, t.tagName)); else {
                    for (l = t.childNodes, i = 0, a = l.length; a > i; i++)r = l[i], r.leaf || (d = !1), o = o.concat(this.getLeafNodes(r, t.childNodes.length));
                    d && ((null != (f = t.attributes) ? f.any : void 0) || t.text) && (t.text || (n = t.dom, t.text = n ? u.containerElemContent(n) : c.parentOfLeafText(t)), s = this.nodeMessage(t, !1), o.push(s))
                }
                return o
                ...
                s = {
                    ...
                    return t.which > 1 || (S = +Date.now(), g === S) ? void 0 : (g = S, v = {
                        time: S,
                    ...
                    return function (r) {
                        ...
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            ...
                            if (a = d.tagName, "click" === r.type) {
                                ...
                                if (-1 === c.indexOf(O, a) && !u.depthInside(d, 4))return
                            }
                ...
                var e, n;
                return null == t && (t = 0), e = [], 3 !== t || null != r.pg ? 4 !== t || (this.pageLoaded = +Date.now(), this.gruser.hasSid()) ? (3 > t && e.push(this.visitMessage()), null == this.pageLoaded && (this.pageLoaded = +Date.now()), 2 === t && (r = f), n = this.pageMessage(), e.push(n), this.send(e, "pv"), this.lastActionTime = +Date.now()) : void this.trackPageView(2) : void 0
                ...
                var r, n, i, o, a, s, d, h, l, f, p, g, v, w, y;
                if (n = {}, w = e.tagName, "IMG" === w ? (null != (p = e.src) ? p.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (n.h = e.src) : c.hasAttr(e, "href") && (i = e.getAttribute("href"), i && 0 !== i.indexOf("javascript") && (n.h = c.normalizePath(i.slice(0, 320)))), c.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0)n.v = e.getAttribute("data-growing-title"); else if (c.hasAttr(e, "title") && e.getAttribute("title").length > 0)n.v = e.getAttribute("title"); else if ("click" === t)if (u.isLeaf(e))if ("IMG" === w)e.alt ? n.v = e.alt : n.h && (s = n.h.split("?")[0], a = s.split("/"), a.length > 0 && (n.v = a[a.length - 1])); else if ("INPUT" === w && -1 !== c.indexOf(C, e.type))n.v = e.value; else if ("svg" === w)for (g = e.childNodes, o = 0, l = g.length; l > o; o++)r = g[o], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (n.v = r.getAttribute("xlink:href")); else y = "", null != e.textContent ? y = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (y = e.innerText.replace(/[\n \t]+/g, " ").trim()), y.length > 0 && (y.length < 50 ? n.v = y : "A" === w && (n.v = y.slice(0, 30))); else-1 !== c.indexOf(b, w) ? n.v = u.containerElemContent(e) : u.isParentOfLeaf(e) && (n.v = c.parentOfLeafText(e)); else if ("change" === t)"TEXTAREA" !== w && ("INPUT" === w && (-1 !== c.indexOf(m, e.type) || "password" !== e.type && (c.hasAttr(e, "growing-track") || c.hasAttr(e, "data-growing-track"))) || "SELECT" === w) && (n.v = e.value); else if ("submit" === t)for (v = e.getElementsByTagName("input"), h = 0, f = v.length; f > h; h++)d = v[h], ("search" === d.type || "text" === d.type && ("q" === d.id || -1 !== d.id.indexOf("search") || -1 !== d.className.indexOf("search") || "q" === d.name || -1 !== d.name.indexOf("search"))) && (n.x = u.path(d).xpath, n.v = d.value.trim());
                return n
                ...
                if (this.send = e, this.currentPath = c.path(), this.currentQuery = c.query(), this.trackPageView(), document.addEventListener)"interactive" === document.readyState || "complete" === document.readyState ? this.domLoadedHandler() : c.bind(document, "DOMContentLoaded", function (t) {
                    return function () {
        ...
        u = t("./guid"), a = t("cookie"), p = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, l = ["I", "SPAN", "EM", "svg"], d = p.detectIE() || 0 / 0, i = function () {
            ...
            return t.prototype.cookieDomain = function () {
                ...
                var t;
                return t = +Date.now(), null != this.sessionId && null != this.lastUpdated && t - this.lastUpdated < 6e4 ? this.sessionId : (this.sessionId = this._currentSessionId(), this.sessionId || (this.sessionId = u()), this.updateSessionId(this.sessionId), this.lastUpdated = t, this.lastSessionId = this.sessionId, this.sessionId)
            }, t.prototype.updateSessionId = function (t, e) {
                return null == e && (e = window.vds.accountId), a.setItem("gr_session_id_" + e, t, 1800, "/", this.cookieDomain()), this.bindCS1WithSession(t)
            }, t.prototype.bindCS1WithSession = function (t) {
                return null == t && (t = this.sessionId), window.grcs.cs1 ? a.setItem("gr_cs1_" + t, window.grcs.cs1, 1800, "/", this.cookieDomain()) : void 0
            }, t.prototype.handleCSChanged = function (t) {
                return this.isNeedToUpdateSessionByCS(t) ? (this.sessionId = u(), this.updateSessionId(this.sessionId, t)) : void 0
            }, t.prototype.isNeedToUpdateSessionByCS = function (t) {
                var e, r;
                return r = this._currentSessionId(t), e = this._currentSessionBindedCS1(r), r && r.trim().length > 0 && window.grcs.cs1 && e && e !== window.grcs.cs1
            ...
            user: function () {
                ...
                var r, n, o, a, s, u, d, c, h, l, g, v;
                if (null == e && (e = !1), a = "", h = !1, n = [], c = !1, d = !1, t === document)return {isIgnore: !0};
                for (r = new i(t); "body" !== r.name && "html" !== r.name;) {
                    if (l = r.path(), r.isIgnore && (h = !0), !c && r.hasObj() && (c = !0, u = r.grObj), !d && r.hasIdx() && (d = !0, s = r.grIdx), e && "" !== a && (-1 !== p.indexOf(f, r.node.tagName) || r.isContainer()))return o = this.path(r.node), n = {
                        x: o.xpath,
                        h: r.href,
                    ...
                    if (a = l + a, g = r.node.parentNode, !g || !g.tagName)break;
                    r = new i(g)
                }
                return v = {xpath: a, containerMessage: n, isIgnore: h}, c && (v.obj = u), d && (v.idx = s), v
            }, index: function (t) {
                var e, r, n, i, o, a, s;
                ...
                if ("BUTTON" === t.tagName) {
                    ...
                    if (p.hasAttr(t, "title") && t.title.length > 0)return t.getAttribute("title");
                        ...
                        if (n = e.data, n.ai === window.vds.accountId && (c = n.mode || n.circleMode, t.isSdkEvent(c) && (!n.fsna || "sdk" === n.fsna))) {
                            ...
                            if (h = n.mode, u.call(o, h) >= 0)a.spreadToInnerIframes(n); else if (n.tna !== window.grSource.name && n.tna && n.tid) {
                                for (r = document.getElementsByTagName("iframe"),
                                         i = 0, d = r.length; d > i; i++)s = r[i], t.notifyInnerIframes(s, n);
                                return
                            }
        ...
        u = t("lzstring"), h = t("./utils"), a = h.detectIE() || 0 / 0, d = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = d ? parseInt(d[2], 10) : !1, s = !1, o && 22 > o ? n = !1 : (n = !0, c = navigator.userAgent, l.call(window, "ArrayBufferView") >= 0 || (-1 !== c.indexOf("Android") ? n = !1 : -1 !== c.indexOf("CPU OS ") ? -1 !== c.indexOf("CPU OS 6_") ? n = !1 : -1 !== c.indexOf("CPU OS 5_") ? n = !1 : -1 !== c.indexOf("CPU OS 4_") ? n = !1 : -1 !== c.indexOf("CPU OS 3_") && (n = !1) : -1 !== c.indexOf("CPU iPhone OS ") ? -1 !== c.indexOf("iPhone OS 6_") ? n = !1 : -1 !== c.indexOf("iPhone OS 5_") ? n = !1 : -1 !== c.indexOf("iPhone OS 4_") && (n = !1) : -1 !== c.indexOf("Intel Mac OS X") && (-1 !== c.indexOf("Mac OS X 10_6") ? n = !1 : -1 !== c.indexOf("Mac OS X 10_7") && (n = !1)))), i = function () {
            function t(t, e, r) {
                this.user = t, this.urlMap = e, this.callback = r, this.send = f(this.send, this)
            }
            ...
            return e = [], i = [], r = [], t.prototype.connect = function (t) {
                ...
                null == e && (e = "action");
                try {
                    return r = "undefined" == typeof Uint8Array || null === Uint8Array || s ? window.XMLHttpRequest && 7 !== a && !s ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)), this.sendRemote(r, e)
                } catch (i) {
                    n = i
                }
            }, t.prototype.sendRemote = function (t, e) {
                var o, u, d;
                if (d = this.urlMap[e], window.grWaitTime = +Date.now() + 300, window.XMLHttpRequest && 7 !== a && !s) {
                    if (o = new XMLHttpRequest, "withCredentials" in o)return o.open("POST", d + "?stm=" + +Date.now(), !0), o.withCredentials = !0, o.onreadystatechange = function (t) {
                        return function () {
                            return 4 === o.readyState ? (t.removeAjax(o), window.grWaitTime = +Date.now() + 10) : void 0
                        }
                    }(this), o.send("undefined" != typeof ArrayBuffer && null !== ArrayBuffer ? n ? t : t.buffer : t), r.push(o);
                    if ("undefined" != typeof XDomainRequest)return o = new XDomainRequest, "http:" === document.location.protocol && (d = d.replace("https://", "http://")), o.open("POST", d + "?stm=" + +Date.now()), o.onload = function (t) {
                        return function () {
                ...
                } else if ("http:" === document.location.protocol && (d = d.replace("https://", "http://")), u = d + "?data=" + t + "&stm=" + +Date.now(), u.length <= 2036)return this.imgSend(u)
        ...
        n = t("./sender"), a = t("./utils"), o = t("./info"), i = function () {
            ...
            var e;
            return e = "0.70", t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                imp: !0,
                hashtag: !1,
                touch: !1,
                bot: !0,
        ...
        var h = function () {
            ...
            return Object.defineProperty(t.prototype, "caseInsensitiveTagName", {
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, f = 4, p = 5, g = 6, b = 7, y = 8, C = 9, O = 10, N = 11, S = 12, x = 13, E = 14, I = c, A = 0; A < e.length;) {
                    var D = e[A++];
                    switch (I) {
                        case c:
                            if (D.match(v)) {
                ...
                switch (1 === g.nodeType && -1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
                    ...
                    case 1:
                        ...
                        if (e += "/", w.childNodes.length > 0) {
                            ...
                            var C, O, N = 0, S = -1 !== u.indexOf(w.tagName);
                            if (S)for (var x = w.firstChild; x; x = x.nextSibling)if (1 === x.nodeType && -1 === s.indexOf(x.tagName)) {
                                S = !1;
                                break
                            }
                            for (var E = w.firstChild; E; E = E.nextSibling) {
                                if (C = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, O = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === E.nodeType) {
                                    if (1 === n[E.tagName])continue;
                                    if (E.hasAttribute("growing-ignore") || E.hasAttribute("data-growing-ignore"))continue;
                                    if (S && -1 !== s.indexOf(E.tagName)) {
                                        y = !1;
                                        continue
                                    }
                                    -1 !== i.indexOf(E.tagName) && (N += 1, O = N), E.hasAttribute("data-growing-idx") && (N = parseInt(E.getAttribute("data-growing-idx")), O = N), E.hasAttribute("data-growing-info") && (C = E.getAttribute("data-growing-info"))
                                }
                                var I = this.serializeNode(E, e, N > 0 && O > 0 ? N : r, C || d);
                                if (null === I)3 != E.nodeType && (y = !1); else if ("undefined" != typeof I.childNodes) {
                                    ...
                                    N > 0 && O > 0 ? I.idx = N : r && (I.idx = r), C ? I.obj = C : d && (I.obj = d), g.childNodes.push(I)
                                } else {
